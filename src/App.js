...
function createElement(id, x1, y1, x2, y2, type) {
  let roughElement;
  if (type === "line") roughElement = generator.line(x1, y1, x2, y2, { roughness: 0 });
  if (type === "rectangle")
  ...
  if (type === "circle")
    roughElement = generator.circle(x1, y1, x2 - x1, y2 - y1, { roughness: 0, strokeWidth: 3 });
  if (type === "arc")
    roughElement = generator.arc(x1, y1, x2, y2, Math.PI, Math.PI * 1.6, false, {
      roughness: 0,
      strokeWidth: 3
    });
